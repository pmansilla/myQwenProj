...
public class WXImageObject implements WXMediaMessage.IMediaObject {
    ...
    public boolean checkArgs() {
        if ((this.imageData == null || this.imageData.length == 0) && ((this.imagePath == null || this.imagePath.length() == 0) && (this.imageUrl == null || this.imageUrl.length() == 0))) {
            cn.sharesdk.framework.utils.e.b().d("checkArgs fail, all arguments are null", new Object[0]);
            return false;
        }
        if (this.imageData != null && this.imageData.length > 10485760) {
            cn.sharesdk.framework.utils.e.b().d("checkArgs fail, content is too large", new Object[0]);
            return false;
        }
        if (this.imagePath != null && this.imagePath.length() > 10240) {
            cn.sharesdk.framework.utils.e.b().d("checkArgs fail, path is invalid", new Object[0]);
            return false;
        }
        if (this.imagePath != null && new File(this.imagePath).length() > 10485760) {
            cn.sharesdk.framework.utils.e.b().d("checkArgs fail, image content is too large", new Object[0]);
            return false;
        }
