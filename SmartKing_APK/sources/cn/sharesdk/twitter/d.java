...
public class d extends cn.sharesdk.framework.authorize.d {
    private String d;
    private String e;
    private cn.sharesdk.framework.authorize.c f;
    ...
    private void b() {
        try {
            Intent component = new Intent().setComponent(new ComponentName(a(this.f.getContext().getPackageManager()), "com.twitter.android.SingleSignOnActivity"));
    ...
    private void c(Intent intent) {
        ...
        Throwable th = new Throwable(intent.getStringExtra("error") + " (" + intent.getIntExtra("error_code", -1) + SQLBuilder.PARENTHESES_RIGHT);
        if (this.c != null) {
            this.c.onFailed(th);
        }
    }
    ...
    public void a() {
        try {
            ...
            this.f.finish();
            if (this.c != null) {
                this.c.onFailed(new Throwable(" You may not have installed Twitter client "));
            }
        } catch (Throwable th) {
            this.f.finish();
            if (this.c != null) {
