...
public class f extends cn.sharesdk.framework.authorize.a implements Handler.Callback, ResizeLayout.OnResizeListener {
    ...
    /* JADX WARN: Type inference failed for: r1v9, types: [cn.sharesdk.framework.authorize.f$2] */
    protected RegisterView b() {
        RegisterView registerView = new RegisterView(this.activity);
        registerView.a().setOnClickListener(new View.OnClickListener() { // from class: cn.sharesdk.framework.authorize.f.1
            /* JADX WARN: Type inference failed for: r1v1, types: [cn.sharesdk.framework.authorize.f$1$1] */
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                new Thread() { // from class: cn.sharesdk.framework.authorize.f.1.1
                    ...
                    public void run() {
                        try {
                            ...
                            cn.sharesdk.framework.utils.e.b().w(th);
                            AuthorizeListener authorizeListener = f.this.a.getAuthorizeListener();
        ...
        b authorizeWebviewClient = this.a.getAuthorizeWebviewClient(this);
        ...
        new Thread() { // from class: cn.sharesdk.framework.authorize.f.2
            @Override // java.lang.Thread, java.lang.Runnable
            public void run() {
                try {
                    Message message = new Message();
                    message.what = 2;
                    if (SchedulerSupport.NONE.equals(DeviceHelper.getInstance(f.this.activity).getDetailNetworkTypeForStatic())) {
                        message.arg1 = 1;
                    ...
                    message.obj = f.this.a.getAuthorizeUrl();
                    UIHandler.sendMessage(message, f.this);
                } catch (Throwable th) {
                    cn.sharesdk.framework.utils.e.b().w(th);
                }
    ...
    public boolean handleMessage(Message message) {
        ...
        if (message.arg1 == 1) {
            ...
            authorizeListener.onError(new Throwable("Network error (platform: " + this.a.getPlatform().getName() + SQLBuilder.PARENTHESES_RIGHT));
            return false;
        }
        ...
        authorizeListener2.onError(new Throwable("Authorize URL is empty (platform: " + this.a.getPlatform().getName() + SQLBuilder.PARENTHESES_RIGHT));
        return false;
    }
    ...
    public void onCreate() {
        if (this.d == null) {
            ...
            try {
                c.getTvTitle().setText(ResHelper.getStringRes(getContext(), "ssdk_" + name.toLowerCase()));
            } catch (Throwable th) {
                try {
    ...
    public boolean onKeyEvent(int i, KeyEvent keyEvent) {
        ...
        if (!onKeyEvent && i == 4 && keyEvent.getAction() == 0 && (authorizeListener = this.a.getAuthorizeListener()) != null) {
            authorizeListener.onCancel();
        }
        if (onKeyEvent) {
            return true;
