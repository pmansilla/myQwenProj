...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        if (str == null || str.isEmpty() || AmapLoc.RESULT_TYPE_GPS.equals(str)) {
            return null;
        }
        try {
            int parseInt = Integer.parseInt(str);
            String str2 = AndroidResUriModel.SCHEME + this.mProviderContext.getPackageName() + FileUriModel.SCHEME + parseInt;
