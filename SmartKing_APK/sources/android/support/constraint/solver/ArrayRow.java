...
public class ArrayRow implements LinearSystem.Row {
    ...
    public String toReadableString() {
        boolean z;
        String str = (this.variable == null ? "" + AmapLoc.RESULT_TYPE_GPS : "" + this.variable) + " = ";
        if (this.constantValue != 0.0f) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                if (variableValue != 0.0f) {
                    ...
                    str = variableValue == 1.0f ? str + solverVariable : str + variableValue + SQLBuilder.BLANK + solverVariable;
                    z = true;
                }
            }
        }
