...
public class Analyzer {
    ...
    private static int resolveDimensionRatio(ConstraintWidget constraintWidget) {
        if (constraintWidget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            int height = constraintWidget.mDimensionRatioSide == 0 ? (int) (constraintWidget.getHeight() * constraintWidget.mDimensionRatio) : (int) (constraintWidget.getHeight() / constraintWidget.mDimensionRatio);
        ...
        int width = constraintWidget.mDimensionRatioSide == 1 ? (int) (constraintWidget.getWidth() * constraintWidget.mDimensionRatio) : (int) (constraintWidget.getWidth() / constraintWidget.mDimensionRatio);
