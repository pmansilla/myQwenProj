...
public final class MimeTypeFilter {
    ...
    public static String matches(@Nullable String str, @NonNull String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(split, str2.split(FileUriModel.SCHEME))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(@Nullable String[] strArr, @NonNull String str) {
        ...
        String[] split = str.split(FileUriModel.SCHEME);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(FileUriModel.SCHEME), split)) {
                return str2;
            }
        }
        return null;
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(FileUriModel.SCHEME), str2.split(FileUriModel.SCHEME));
    }
