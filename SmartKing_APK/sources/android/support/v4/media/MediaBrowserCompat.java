        ...
        protected void onReceiveResult(int i, Bundle bundle) {
            ...
            switch (i) {
                ...
                case 1:
                    ...
                    return;
                default:
                    Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i + " (extras=" + this.mExtras + ", resultData=" + bundle + SQLBuilder.PARENTHESES_RIGHT);
                    return;
            }
        }
    }
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            if (this.mState == 0 || this.mState == 1) {
                ...
                throw new IllegalStateException("connect() called while neigther disconnecting nor disconnected (state=" + getStateLabel(this.mState) + SQLBuilder.PARENTHESES_RIGHT);
            }
        }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException("getExtras() called while not connected (state=" + getStateLabel(this.mState) + SQLBuilder.PARENTHESES_RIGHT);
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException("getRoot() called while not connected(state=" + getStateLabel(this.mState) + SQLBuilder.PARENTHESES_RIGHT);
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException("getServiceComponent() called while not connected (state=" + this.mState + SQLBuilder.PARENTHESES_RIGHT);
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException("getSessionToken() called while not connected(state=" + this.mState + SQLBuilder.PARENTHESES_RIGHT);
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException("search() called while not connected (state=" + getStateLabel(this.mState) + SQLBuilder.PARENTHESES_RIGHT);
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException e) {
