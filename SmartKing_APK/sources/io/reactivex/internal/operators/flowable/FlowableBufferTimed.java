        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.s, subscription)) {
                ...
                try {
                    ...
                    this.w.schedule(new Runnable() { // from class: io.reactivex.internal.operators.flowable.FlowableBufferTimed.BufferSkipBoundedSubscriber.1
                        @Override // java.lang.Runnable
                        public void run() {
                            synchronized (BufferSkipBoundedSubscriber.this) {
                                BufferSkipBoundedSubscriber.this.buffers.remove(collection);
                            }
                            BufferSkipBoundedSubscriber.this.fastPathOrderedEmitMax(collection, false, BufferSkipBoundedSubscriber.this.w);
                        }
        ...
        public void run() {
            ...
            try {
                ...
                synchronized (this) {
                    ...
                    this.buffers.add(collection);
                    this.w.schedule(new Runnable() { // from class: io.reactivex.internal.operators.flowable.FlowableBufferTimed.BufferSkipBoundedSubscriber.2
                        @Override // java.lang.Runnable
                        public void run() {
                            synchronized (BufferSkipBoundedSubscriber.this) {
                                BufferSkipBoundedSubscriber.this.buffers.remove(collection);
