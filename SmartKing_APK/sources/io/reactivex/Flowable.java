...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public static <T> Flowable<T> concatEager(Publisher<? extends Publisher<? extends T>> publisher, int i, int i2) {
        return RxJavaPlugins.onAssembly(new FlowableConcatMapEager(publisher, Functions.identity(), i, i2, ErrorMode.IMMEDIATE));
    }
    ...
    private Flowable<T> timeout0(long j, TimeUnit timeUnit, Flowable<? extends T> flowable, Scheduler scheduler) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return RxJavaPlugins.onAssembly(new FlowableTimeoutTimed(this, j, timeUnit, scheduler, flowable));
    }
    ...
    public final Flowable<T> strict() {
        return RxJavaPlugins.onAssembly(new FlowableStrict(this));
    }
    ...
    public final Disposable subscribe(Consumer<? super T> consumer) {
        return subscribe(consumer, Functions.ERROR_CONSUMER, Functions.EMPTY_ACTION, FlowableInternalHelper.RequestMax.INSTANCE);
    }
