...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public static <T> Flowable<T> concat(Publisher<? extends MaybeSource<? extends T>> publisher, int i) {
        ...
        return RxJavaPlugins.onAssembly(new FlowableConcatMap(publisher, MaybeToPublisher.instance(), i, ErrorMode.IMMEDIATE));
    }
    ...
    public static <T> Flowable<T> merge(Publisher<? extends MaybeSource<? extends T>> publisher, int i) {
        return RxJavaPlugins.onAssembly(new FlowableFlatMap(publisher, MaybeToPublisher.instance(), false, i, Flowable.bufferSize()));
    }
