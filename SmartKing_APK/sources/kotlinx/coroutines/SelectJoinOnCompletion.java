...
final class SelectJoinOnCompletion<R> extends JobNode<JobSupport> {
    ...
    public SelectJoinOnCompletion(@NotNull JobSupport job, @NotNull SelectInstance<? super R> select, @NotNull Function1<? super Continuation<? super R>, ? extends Object> block) {
        super(job);
