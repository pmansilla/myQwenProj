...
public final class FlowKt__ZipKt$asChannel$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$asChannel$1$1, reason: invalid class name */
    /* loaded from: classes2.dex */
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    SendChannel channel = this.$receiver$0.getChannel();
                    if (obj2 == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$asChannel$1(Flow flow, Continuation continuation) {
        super(2, continuation);
        this.$flow = flow;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        FlowKt__ZipKt$asChannel$1 flowKt__ZipKt$asChannel$1 = new FlowKt__ZipKt$asChannel$1(this.$flow, completion);
        flowKt__ZipKt$asChannel$1.p$ = (ProducerScope) obj;
    ...
    public final Object invoke(ProducerScope<? super Object> producerScope, Continuation<? super Unit> continuation) {
        return ((FlowKt__ZipKt$asChannel$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
