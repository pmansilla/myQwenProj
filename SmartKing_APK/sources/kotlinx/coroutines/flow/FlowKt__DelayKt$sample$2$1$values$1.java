...
final class FlowKt__DelayKt$sample$2$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    int label;
    ...
    /* renamed from: kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$1$values$1$1, reason: invalid class name */
    /* loaded from: classes2.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__DelayKt$sample$2$1$values$1(FlowKt__DelayKt$sample$2.AnonymousClass1 anonymousClass1, Continuation continuation) {
        super(2, continuation);
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        FlowKt__DelayKt$sample$2$1$values$1 flowKt__DelayKt$sample$2$1$values$1 = new FlowKt__DelayKt$sample$2$1$values$1(this.this$0, completion);
        flowKt__DelayKt$sample$2$1$values$1.p$ = (ProducerScope) obj;
        return flowKt__DelayKt$sample$2$1$values$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(ProducerScope<? super Object> producerScope, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$sample$2$1$values$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                Flow flow = FlowKt__DelayKt$sample$2.this.$this_sample;
