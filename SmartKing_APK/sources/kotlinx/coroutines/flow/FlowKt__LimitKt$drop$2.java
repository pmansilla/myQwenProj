...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$drop$2", f = "Limit.kt", i = {0}, l = {24}, m = "invokeSuspend", n = {"skipped"}, s = {"L$0"})
/* loaded from: classes2.dex */
public final class FlowKt__LimitKt$drop$2<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$drop$2$1", f = "Limit.kt", i = {}, l = {25}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<T, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$receiver$0, this.$skipped, completion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__LimitKt$drop$2(Flow flow, int i, Continuation continuation) {
        super(2, continuation);
        this.$this_drop = flow;
        this.$count = i;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        FlowKt__LimitKt$drop$2 flowKt__LimitKt$drop$2 = new FlowKt__LimitKt$drop$2(this.$this_drop, this.$count, completion);
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__LimitKt$drop$2) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
