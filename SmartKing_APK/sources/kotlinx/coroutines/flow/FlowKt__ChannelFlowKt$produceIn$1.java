...
public final class FlowKt__ChannelFlowKt$produceIn$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    final /* synthetic */ Flow $this_produceIn;
    int label;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ChannelFlowKt$produceIn$1(Flow flow, Continuation continuation) {
        super(2, continuation);
        this.$this_produceIn = flow;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        FlowKt__ChannelFlowKt$produceIn$1 flowKt__ChannelFlowKt$produceIn$1 = new FlowKt__ChannelFlowKt$produceIn$1(this.$this_produceIn, completion);
        flowKt__ChannelFlowKt$produceIn$1.p$ = (ProducerScope) obj;
        return flowKt__ChannelFlowKt$produceIn$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__ChannelFlowKt$produceIn$1) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
