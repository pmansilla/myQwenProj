...
public final class FlowKt__ChannelFlowKt$broadcastIn$1<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    final /* synthetic */ Flow $this_broadcastIn;
    int label;
    ...
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ChannelFlowKt$broadcastIn$1$1, reason: invalid class name */
    /* loaded from: classes2.dex */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ChannelFlowKt$broadcastIn$1(Flow flow, Continuation continuation) {
        super(2, continuation);
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        FlowKt__ChannelFlowKt$broadcastIn$1 flowKt__ChannelFlowKt$broadcastIn$1 = new FlowKt__ChannelFlowKt$broadcastIn$1(this.$this_broadcastIn, completion);
        flowKt__ChannelFlowKt$broadcastIn$1.p$ = (ProducerScope) obj;
        return flowKt__ChannelFlowKt$broadcastIn$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__ChannelFlowKt$broadcastIn$1) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                Flow flow = this.$this_broadcastIn;
