...
public final class FlowKt__ContextKt$flowWith$1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ContextKt$flowWith$1(Flow flow, int i, Function1 function1, CoroutineContext coroutineContext, Continuation continuation) {
        super(2, continuation);
        this.$source = flow;
        this.$bufferSize = i;
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        FlowKt__ContextKt$flowWith$1 flowKt__ContextKt$flowWith$1 = new FlowKt__ContextKt$flowWith$1(this.$source, this.$bufferSize, this.$builder, this.$flowContext, completion);
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__ContextKt$flowWith$1) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                Flow flowOn = FlowKt.flowOn(this.$source, minusKey, this.$bufferSize);
                Flow flowOn2 = FlowKt.flowOn((Flow) this.$builder.invoke(flowOn), this.$flowContext, this.$bufferSize);
                AnonymousClass1 anonymousClass1 = new AnonymousClass1(flowCollector, null);
                this.L$0 = minusKey;
                this.L$1 = flowOn;
                this.label = 1;
                if (FlowKt.collect(flowOn2, anonymousClass1, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                break;
            case 1:
