...
public final class ExceptionsConstuctorKt {
            ...
            case 0:
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(@NotNull Throwable e) {
                        ...
                        th2.initCause(e);
                        m33constructorimpl = Result.m33constructorimpl(th2);
                ...
                if (Intrinsics.areEqual(cls, Throwable.class)) {
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$2
                        ...
                        public final Throwable invoke(@NotNull Throwable e) {
                            ...
                            m33constructorimpl = Result.m33constructorimpl((Throwable) newInstance);
                            if (Result.m39isFailureimpl(m33constructorimpl)) {
                                m33constructorimpl = null;
                            }
                            return (Throwable) m33constructorimpl;
    ...
    private static final int fieldsCountOrDefault(@NotNull Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m33constructorimpl = Result.m33constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m33constructorimpl = Result.m33constructorimpl(ResultKt.createFailure(th));
        }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$safeCtor$1
            ...
            public final Throwable invoke(@NotNull Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    m33constructorimpl = Result.m33constructorimpl((Throwable) Function1.this.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m33constructorimpl = Result.m33constructorimpl(ResultKt.createFailure(th));
                }
    ...
    public static final <E extends Throwable> E tryCopyException(@NotNull E exception) {
        ...
        if (exception instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                m33constructorimpl = Result.m33constructorimpl(((CopyableThrowable) exception).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m33constructorimpl = Result.m33constructorimpl(ResultKt.createFailure(th));
            }
