...
public interface ChildJob extends Job {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(ChildJob childJob, R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        ...
        @NotNull
        public static CoroutineContext plus(ChildJob childJob, @NotNull CoroutineContext context) {
        ...
        @NotNull
        public static Job plus(ChildJob childJob, @NotNull Job other) {
