...
public final /* synthetic */ class JobKt__FutureKt {
    public static final void cancelFutureOnCancellation(@NotNull CancellableContinuation<?> cancelFutureOnCancellation, @NotNull Future<?> future) {
    ...
    @NotNull
    public static final DisposableHandle cancelFutureOnCompletion(@NotNull Job cancelFutureOnCompletion, @NotNull Future<?> future) {
