...
public final class ResumeModeKt {
    ...
    public static final <T> void resumeMode(@NotNull Continuation<? super T> resumeMode, T t, int i) {
        ...
        switch (i) {
            case 0:
                ...
                resumeMode.resumeWith(Result.m33constructorimpl(t));
                return;
            case 1:
    ...
    public static final <T> void resumeUninterceptedMode(@NotNull Continuation<? super T> resumeUninterceptedMode, T t, int i) {
        ...
        switch (i) {
            case 0:
                ...
                Result.Companion companion = Result.INSTANCE;
                intercepted.resumeWith(Result.m33constructorimpl(t));
                return;
            case 1:
            ...
            case 2:
                Result.Companion companion2 = Result.INSTANCE;
                resumeUninterceptedMode.resumeWith(Result.m33constructorimpl(t));
                return;
            case 3:
    ...
    public static final <T> void resumeUninterceptedWithExceptionMode(@NotNull Continuation<? super T> resumeUninterceptedWithExceptionMode, @NotNull Throwable exception, int i) {
        ...
        switch (i) {
            case 0:
                ...
                Result.Companion companion = Result.INSTANCE;
                intercepted.resumeWith(Result.m33constructorimpl(ResultKt.createFailure(exception)));
                return;
            case 1:
            ...
            case 2:
                Result.Companion companion2 = Result.INSTANCE;
                resumeUninterceptedWithExceptionMode.resumeWith(Result.m33constructorimpl(ResultKt.createFailure(exception)));
                return;
            case 3:
    ...
    public static final <T> void resumeWithExceptionMode(@NotNull Continuation<? super T> resumeWithExceptionMode, @NotNull Throwable exception, int i) {
        ...
        switch (i) {
            case 0:
                Result.Companion companion = Result.INSTANCE;
                resumeWithExceptionMode.resumeWith(Result.m33constructorimpl(ResultKt.createFailure(exception)));
                return;
            case 1:
