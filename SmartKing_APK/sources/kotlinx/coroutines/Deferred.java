...
public interface Deferred<T> extends Job {
    ...
    public static final class DefaultImpls {
        public static <T, R> R fold(Deferred<? extends T> deferred, R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        ...
        @NotNull
        public static <T> CoroutineContext plus(Deferred<? extends T> deferred, @NotNull CoroutineContext context) {
        ...
        @NotNull
        public static <T> Job plus(Deferred<? extends T> deferred, @NotNull Job other) {
