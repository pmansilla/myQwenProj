...
public interface Delay {
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(Delay delay, long j, @NotNull Continuation<? super Unit> continuation) {
            ...
            delay.mo932scheduleResumeAfterDelay(j, cancellableContinuationImpl);
    ...
    void mo932scheduleResumeAfterDelay(long timeMillis, @NotNull CancellableContinuation<? super Unit> continuation);
}
