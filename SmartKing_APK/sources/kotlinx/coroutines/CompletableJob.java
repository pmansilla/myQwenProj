...
public interface CompletableJob extends Job {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(CompletableJob completableJob, R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        ...
        @NotNull
        public static CoroutineContext plus(CompletableJob completableJob, @NotNull CoroutineContext context) {
        ...
        @NotNull
        public static Job plus(CompletableJob completableJob, @NotNull Job other) {
