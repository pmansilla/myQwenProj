...
public interface CompletableDeferred<T> extends Deferred<T> {
    ...
    public static final class DefaultImpls {
        public static <T, R> R fold(CompletableDeferred<T> completableDeferred, R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        ...
        @NotNull
        public static <T> CoroutineContext plus(CompletableDeferred<T> completableDeferred, @NotNull CoroutineContext context) {
        ...
        @NotNull
        public static <T> Job plus(CompletableDeferred<T> completableDeferred, @NotNull Job other) {
