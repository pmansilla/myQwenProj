            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl2.resumeWith(Result.m33constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = closed.getReceiveException();
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl2.resumeWith(Result.m33constructorimpl(ResultKt.createFailure(receiveException)));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean2 = Boxing.boxBoolean(true);
                    Result.Companion companion3 = Result.INSTANCE;
                    cancellableContinuationImpl2.resumeWith(Result.m33constructorimpl(boxBoolean2));
                    break;
                }
            }
    ...
    public static final class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            ...
            if (closed.closeCause == null && this.nullOnClose) {
                ...
                Throwable receiveException = closed.getReceiveException();
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m33constructorimpl(ResultKt.createFailure(receiveException)));
            }
        }
    ...
    */
    ...
    public void cleanupSendQueueOnCancel() {
        ...
        while (true) {
            ...
            takeFirstSendOrPeekClosed.mo929resumeSendClosed(closedForSend);
        }
    }
    ...
    final /* synthetic */ Object receiveOrNullSuspend(@NotNull Continuation<? super E> continuation) {
        ...
        while (true) {
            ...
            if (pollInternal instanceof Closed) {
                ...
                if (closed.closeCause == null) {
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl2.resumeWith(Result.m33constructorimpl(null));
                } else {
                    Throwable th = closed.closeCause;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuationImpl2.resumeWith(Result.m33constructorimpl(ResultKt.createFailure(th)));
                }
            } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                Result.Companion companion3 = Result.INSTANCE;
                cancellableContinuationImpl2.resumeWith(Result.m33constructorimpl(pollInternal));
                break;
            }
        }
        Object result = cancellableContinuationImpl.getResult();
