...
public final class BroadcastKt {
    @NotNull
    public static final <E> BroadcastChannel<E> broadcast(@NotNull CoroutineScope broadcast, @NotNull CoroutineContext context, int i, @NotNull CoroutineStart start, @Nullable Function1<? super Throwable, Unit> function1, @BuilderInference @NotNull Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {
        ...
        LazyBroadcastCoroutine lazyBroadcastCoroutine = start.isLazy() ? new LazyBroadcastCoroutine(newCoroutineContext, BroadcastChannel, block) : new BroadcastCoroutine(newCoroutineContext, BroadcastChannel, true);
        if (function1 != null) {
    ...
    @NotNull
    public static final <E> BroadcastChannel<E> broadcast(@NotNull ReceiveChannel<? extends E> broadcast, int i, @NotNull CoroutineStart start) {
        Intrinsics.checkParameterIsNotNull(broadcast, "$this$broadcast");
        Intrinsics.checkParameterIsNotNull(start, "start");
