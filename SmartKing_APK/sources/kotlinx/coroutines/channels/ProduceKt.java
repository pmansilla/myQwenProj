...
public final class ProduceKt {
    ...
    @NotNull
    public static final <E> ReceiveChannel<E> produce(@NotNull CoroutineScope produce, @NotNull CoroutineContext context, int i, @BuilderInference @NotNull Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkParameterIsNotNull(produce, "$this$produce");
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(block, "block");
        ProducerCoroutine producerCoroutine = new ProducerCoroutine(CoroutineContextKt.newCoroutineContext(produce, context), ChannelKt.Channel(i));
