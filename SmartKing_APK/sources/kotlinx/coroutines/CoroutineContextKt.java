...
public final class CoroutineContextKt {
    ...
    public static final String getCoroutineName(@NotNull CoroutineContext coroutineName) {
        ...
        if (!DebugKt.DEBUG || (coroutineId = (CoroutineId) coroutineName.get(CoroutineId.INSTANCE)) == null) {
            return null;
        }
    ...
    @NotNull
    public static final CoroutineContext minusId(@NotNull CoroutineContext minusId) {
        Intrinsics.checkParameterIsNotNull(minusId, "$this$minusId");
        return minusId.minusKey(CoroutineId.INSTANCE);
    }
    ...
    public static final <T> T withCoroutineContext(@NotNull CoroutineContext context, @Nullable Object obj, @NotNull Function0<? extends T> block) {
        Intrinsics.checkParameterIsNotNull(context, "context");
