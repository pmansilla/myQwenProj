...
public interface SelectInstance<R> {
    ...
    @Nullable
    Object performAtomicIfNotSelected(@NotNull AtomicDesc desc);

    @Nullable
    Object performAtomicTrySelect(@NotNull AtomicDesc desc);

    void resumeSelectCancellableWithException(@NotNull Throwable exception);

    boolean trySelect(@Nullable Object idempotent);
}
