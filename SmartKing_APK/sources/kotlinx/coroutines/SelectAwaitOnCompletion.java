...
public final class SelectAwaitOnCompletion<T, R> extends JobNode<JobSupport> {
    ...
    public SelectAwaitOnCompletion(@NotNull JobSupport job, @NotNull SelectInstance<? super R> select, @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> block) {
        super(job);
