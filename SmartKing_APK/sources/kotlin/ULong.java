...
public final class ULong implements Comparable<ULong> {
    ...
    private static final int m185compareToWZ4Q5Ns(long j, int i) {
        return UnsignedKt.ulongCompare(j, m187constructorimpl(i & UIDFolder.MAXUID));
    }

    @InlineOnly
    /* renamed from: compareTo-xj2QHRw, reason: not valid java name */
    private static final int m186compareToxj2QHRw(long j, short s) {
        return UnsignedKt.ulongCompare(j, m187constructorimpl(s & 65535));
    }
    ...
    private static final long m189div7apg3OU(long j, byte b) {
        return UnsignedKt.m318ulongDivideeb3DHEI(j, m187constructorimpl(b & 255));
    }
    ...
    private static final long m191divWZ4Q5Ns(long j, int i) {
        return UnsignedKt.m318ulongDivideeb3DHEI(j, m187constructorimpl(i & UIDFolder.MAXUID));
    }

    @InlineOnly
    /* renamed from: div-xj2QHRw, reason: not valid java name */
    private static final long m192divxj2QHRw(long j, short s) {
        return UnsignedKt.m318ulongDivideeb3DHEI(j, m187constructorimpl(s & 65535));
    }
    ...
    private static final long m200minusWZ4Q5Ns(long j, int i) {
        return m187constructorimpl(j - m187constructorimpl(i & UIDFolder.MAXUID));
    }

    @InlineOnly
    /* renamed from: minus-xj2QHRw, reason: not valid java name */
    private static final long m201minusxj2QHRw(long j, short s) {
        return m187constructorimpl(j - m187constructorimpl(s & 65535));
    }
    ...
    private static final long m208rem7apg3OU(long j, byte b) {
        return UnsignedKt.m319ulongRemaindereb3DHEI(j, m187constructorimpl(b & 255));
    }
    ...
    private static final long m210remWZ4Q5Ns(long j, int i) {
        return UnsignedKt.m319ulongRemaindereb3DHEI(j, m187constructorimpl(i & UIDFolder.MAXUID));
    }

    @InlineOnly
    /* renamed from: rem-xj2QHRw, reason: not valid java name */
    private static final long m211remxj2QHRw(long j, short s) {
        return UnsignedKt.m319ulongRemaindereb3DHEI(j, m187constructorimpl(s & 65535));
    }

    @InlineOnly
    /* renamed from: shl-impl, reason: not valid java name */
    private static final long m212shlimpl(long j, int i) {
        return m187constructorimpl(j << i);
    }

    @InlineOnly
    /* renamed from: shr-impl, reason: not valid java name */
    private static final long m213shrimpl(long j, int i) {
        return m187constructorimpl(j >>> i);
    }
    ...
    private static final short m228toUShortimpl(long j) {
        return UShort.m256constructorimpl((short) j);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ULong uLong) {
        return m183compareToVKZWuLQ(uLong.getData());
    }

    public boolean equals(Object other) {
        return m193equalsimpl(this.data, other);
    }
