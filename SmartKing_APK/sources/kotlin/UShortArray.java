...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m298boximpl(@NotNull short[] v) {
    ...
    @NotNull
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m300constructorimpl(@NotNull short[] storage) {
        Intrinsics.checkParameterIsNotNull(storage, "storage");
        return storage;
    }
    ...
    public static boolean m302containsAllimpl(short[] sArr, @NotNull Collection<UShort> elements) {
    ...
    public static boolean m303equalsimpl(short[] sArr, @Nullable Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m304equalsimpl0(@NotNull short[] p1, @NotNull short[] p2) {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m313containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }
    ...
    public boolean equals(Object other) {
        return m303equalsimpl(this.storage, other);
    }
