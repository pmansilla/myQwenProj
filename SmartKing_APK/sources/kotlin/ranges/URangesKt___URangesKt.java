...
class URangesKt___URangesKt {
    ...
    public static final long m893coerceInJPwROB0(long j, @NotNull ClosedRange<ULong> range) {
        Intrinsics.checkParameterIsNotNull(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m181boximpl(j), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (!range.isEmpty()) {
    ...
    public static final short m894coerceInVKSA0NQ(short s, short s2, short s3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UShort.m291toStringimpl(s3) + " is less than minimum " + UShort.m291toStringimpl(s2) + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
    ...
    public static final int m895coerceInWZ9TVnA(int i, int i2, int i3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UInt.m155toStringimpl(i3) + " is less than minimum " + UInt.m155toStringimpl(i2) + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
    ...
    public static final byte m896coerceInb33U2AM(byte b, byte b2, byte b3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + UByte.m86toStringimpl(b3) + " is less than minimum " + UByte.m86toStringimpl(b2) + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }
    ...
    public static final long m897coerceInsambcqE(long j, long j2, long j3) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ULong.m224toStringimpl(j3) + " is less than minimum " + ULong.m224toStringimpl(j2) + ClassUtils.PACKAGE_SEPARATOR_CHAR);
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: coerceIn-wuiCnnA, reason: not valid java name */
    public static final int m898coerceInwuiCnnA(int i, @NotNull ClosedRange<UInt> range) {
        Intrinsics.checkParameterIsNotNull(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m112boximpl(i), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (!range.isEmpty()) {
    ...
    public static final boolean m899contains68kG9v0(@NotNull UIntRange contains, byte b) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return contains.m882containsWZ4Q5Ns(UInt.m118constructorimpl(b & 255));
    }
    ...
    private static final boolean m900containsGYNo2lE(@NotNull ULongRange contains, ULong uLong) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return uLong != null && contains.m884containsVKZWuLQ(uLong.getData());
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: contains-Gab390E, reason: not valid java name */
    public static final boolean m901containsGab390E(@NotNull ULongRange contains, int i) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return contains.m884containsVKZWuLQ(ULong.m187constructorimpl(i & UIDFolder.MAXUID));
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: contains-ULb-yJY, reason: not valid java name */
    public static final boolean m902containsULbyJY(@NotNull ULongRange contains, byte b) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return contains.m884containsVKZWuLQ(ULong.m187constructorimpl(b & 255));
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: contains-ZsK3CEQ, reason: not valid java name */
    public static final boolean m903containsZsK3CEQ(@NotNull UIntRange contains, short s) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return contains.m882containsWZ4Q5Ns(UInt.m118constructorimpl(s & 65535));
    }
    ...
    private static final boolean m904containsbiwQdVI(@NotNull UIntRange contains, UInt uInt) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return uInt != null && contains.m882containsWZ4Q5Ns(uInt.getData());
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: contains-fz5IDCE, reason: not valid java name */
    public static final boolean m905containsfz5IDCE(@NotNull UIntRange contains, long j) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return ULong.m187constructorimpl(j >>> 32) == 0 && contains.m882containsWZ4Q5Ns(UInt.m118constructorimpl((int) j));
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: contains-uhHAxoY, reason: not valid java name */
    public static final boolean m906containsuhHAxoY(@NotNull ULongRange contains, short s) {
        Intrinsics.checkParameterIsNotNull(contains, "$this$contains");
        return contains.m884containsVKZWuLQ(ULong.m187constructorimpl(s & 65535));
    }
    ...
    public static final UIntProgression m907downTo5PvTz6A(short s, short s2) {
        return UIntProgression.INSTANCE.m881fromClosedRangeNkh28Cs(UInt.m118constructorimpl(s & 65535), UInt.m118constructorimpl(s2 & 65535), -1);
    }
    ...
    public static final UIntProgression m908downToJ1ME1BU(int i, int i2) {
        return UIntProgression.INSTANCE.m881fromClosedRangeNkh28Cs(i, i2, -1);
    }
    ...
    public static final UIntProgression m909downToKr8caGY(byte b, byte b2) {
        return UIntProgression.INSTANCE.m881fromClosedRangeNkh28Cs(UInt.m118constructorimpl(b & 255), UInt.m118constructorimpl(b2 & 255), -1);
    }
    ...
    public static final ULongProgression m910downToeb3DHEI(long j, long j2) {
        return ULongProgression.INSTANCE.m883fromClosedRange7ftBX0g(j, j2, -1L);
    }
    ...
    public static final UIntProgression reversed(@NotNull UIntProgression reversed) {
        ...
        return UIntProgression.INSTANCE.m881fromClosedRangeNkh28Cs(reversed.getLast(), reversed.getFirst(), -reversed.getStep());
    }
    ...
    public static final ULongProgression reversed(@NotNull ULongProgression reversed) {
        Intrinsics.checkParameterIsNotNull(reversed, "$this$reversed");
        return ULongProgression.INSTANCE.m883fromClosedRange7ftBX0g(reversed.getLast(), reversed.getFirst(), -reversed.getStep());
    }
    ...
    public static final UIntRange m911until5PvTz6A(short s, short s2) {
        return Intrinsics.compare(s2 & 65535, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m118constructorimpl(s & 65535), UInt.m118constructorimpl(UInt.m118constructorimpl(r3) - 1), null);
    }
    ...
    public static final UIntRange m912untilJ1ME1BU(int i, int i2) {
        return UnsignedKt.uintCompare(i2, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(i, UInt.m118constructorimpl(i2 - 1), null);
    }
    ...
    public static final UIntRange m913untilKr8caGY(byte b, byte b2) {
        return Intrinsics.compare(b2 & 255, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m118constructorimpl(b & 255), UInt.m118constructorimpl(UInt.m118constructorimpl(r3) - 1), null);
    }
    ...
    public static final ULongRange m914untileb3DHEI(long j, long j2) {
        return UnsignedKt.ulongCompare(j2, 0L) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange(j, ULong.m187constructorimpl(j2 - ULong.m187constructorimpl(1 & UIDFolder.MAXUID)), null);
    }
}
