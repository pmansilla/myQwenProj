...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(UInt uInt) {
        return m882containsWZ4Q5Ns(uInt.getData());
    }

    /* renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m882containsWZ4Q5Ns(int value) {
    ...
    public UInt getEndInclusive() {
        return UInt.m112boximpl(getLast());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public UInt getStart() {
        return UInt.m112boximpl(getFirst());
    }
    ...
    public String toString() {
        return UInt.m155toStringimpl(getFirst()) + ".." + UInt.m155toStringimpl(getLast());
    }
}
