...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m883fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m866getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m187constructorimpl(this.first ^ ULong.m187constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m187constructorimpl(this.last ^ ULong.m187constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m224toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m224toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
