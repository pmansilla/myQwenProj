...
public abstract class Random {
    ...
    */
    ...
    public long nextLong(long from, long until) {
        ...
        if (j3 > 0) {
            if (((-j3) & j3) == j3) {
                j2 = ((int) j3) != 0 ? nextBits(PlatformRandomKt.fastLog2(r12)) & UIDFolder.MAXUID : ((int) (j3 >>> 32)) == 1 ? nextInt() & UIDFolder.MAXUID : (nextBits(PlatformRandomKt.fastLog2(r0)) << 32) + nextInt();
                return from + j2;
            }
            do {
                nextLong = nextLong() >>> 1;
