...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        */
        ...
        ParseResult parse(HttpUrl httpUrl, String str) {
                ...
                while (true) {
                    ...
                    if (charAt != 65535 && charAt != '#' && charAt != '/' && charAt != '\\') {
                        switch (charAt) {
                            case '@':
                                if (z) {
                                    this.encodedPassword += "%40" + HttpUrl.canonicalize(str, i, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, true);
                                } else {
            ...
            int delimiterOffset3 = HttpUrl.delimiterOffset(str, delimiterOffset, skipTrailingAsciiWhitespace, "?#");
    ...
    public List<String> encodedPathSegments() {
        ...
        while (indexOf < delimiterOffset) {
            int i = indexOf + 1;
            int delimiterOffset2 = delimiterOffset(this.url, i, delimiterOffset, FileUriModel.SCHEME);
