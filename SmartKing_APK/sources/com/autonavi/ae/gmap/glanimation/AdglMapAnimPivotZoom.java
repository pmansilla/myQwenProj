...
public class AdglMapAnimPivotZoom extends AbstractAdglAnimation {
    ...
    public void doAnimation(Object obj) {
        ...
        if (!this.zoomCenter) {
            float pow = 1.0f - (1.0f / ((float) Math.pow(2.0d, curValue - this.zoomParam.getFromValue())));
            gLMapState.setMapGeoCenter(this.beginCenterGeoX + ((int) ((this.pivotGeoX - this.beginCenterGeoX) * pow)), this.beginCenterGeoY + ((int) ((this.pivotGeoY - this.beginCenterGeoY) * pow)));
        }
