...
public class TextTextureGenerator {
    ...
    private void createTextParam() {
        ...
        try {
            ...
            try {
                ...
                f2 = -27.832031f;
                this.baseLine = ((this.textFontsizeTrue - (f + f2)) / 2.0f) + f3 + 0.5f;
            }
    ...
    public byte[] getTextPixelBuffer(int i, int i2) {
        ...
        try {
            ...
            float f3 = measureText - this.textFontsizeTrue;
            if (textAlign == Paint.Align.CENTER || f3 < 4.0f) {
                canvas.drawText(cArr, 0, 1, this.startX, f2, this.textPaint);
            } else {
                this.textPaint.setTextAlign(Paint.Align.CENTER);
                this.textPaint.setTextSize(this.textFontsizeTrue - f3);
                canvas.drawText(cArr, 0, 1, (this.textFontsizeTrue - f3) / 2.0f, f2, this.textPaint);
