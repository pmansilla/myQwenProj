...
public class GLAnimationSet extends GLAnimation {
    ...
    /* renamed from: clone */
    public GLAnimationSet mo22clone() throws CloneNotSupportedException {
        GLAnimationSet gLAnimationSet = (GLAnimationSet) super.mo22clone();
        ...
        for (int i = 0; i < size; i++) {
            gLAnimationSet.mAnimations.add(arrayList.get(i).mo22clone());
        }
