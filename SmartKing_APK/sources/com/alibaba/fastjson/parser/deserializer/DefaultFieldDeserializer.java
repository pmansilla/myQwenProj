...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    public void parseField(DefaultJSONParser defaultJSONParser, Object obj, Type type, Map<String, Object> map) {
        ...
        Type type3 = type2;
        Object deserialze = (!(objectDeserializer instanceof JavaBeanDeserializer) || this.fieldInfo.parserFeatures == 0) ? (this.fieldInfo.format == null || !(objectDeserializer instanceof ContextObjectDeserializer)) ? objectDeserializer.deserialze(defaultJSONParser, type3, this.fieldInfo.name) : ((ContextObjectDeserializer) objectDeserializer).deserialze(defaultJSONParser, type3, this.fieldInfo.name, this.fieldInfo.format, this.fieldInfo.parserFeatures) : ((JavaBeanDeserializer) objectDeserializer).deserialze(defaultJSONParser, type3, this.fieldInfo.name, this.fieldInfo.parserFeatures);
