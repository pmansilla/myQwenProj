...
public class as {
    ...
    public static long a(int i, int i2) {
        return (i2 & UIDFolder.MAXUID) | ((i & UIDFolder.MAXUID) << 32);
    }
            ...
            if (list != null) {
                if (!list.isEmpty()) {
                    ...
                    for (r rVar : list) {
                        if (rVar.a == 1) {
                            w wVar = (w) rVar.f;
                            aVar = new a(wVar.c, wVar.d, wVar.e);
                        } else if (rVar.a == 3) {
                            x xVar = (x) rVar.f;
                            aVar = new a(xVar.c, xVar.d, xVar.f);
                        } else if (rVar.a == 4) {
                            z zVar = (z) rVar.f;
                            aVar = new a(zVar.c, zVar.d, zVar.f);
                        } else if (rVar.a == 2) {
                            p pVar = (p) rVar.f;
                            aVar = new a(pVar.b, pVar.c, pVar.f);
                        }
                        arrayList.add(aVar);
                    }
                    a.a(arrayList);
