...
public class bk {
    public static int a(fc fcVar, Context context) {
        ...
        try {
            ...
            int a3 = TextUtils.isEmpty(com.amap.location.common.a.c(context)) ? Integer.MIN_VALUE : fcVar.a(com.amap.location.common.a.c(context));
            CharSequence b = com.amap.location.common.a.b(context);
            int a4 = TextUtils.isEmpty(b) ? Integer.MIN_VALUE : fcVar.a(b);
            CharSequence a5 = com.amap.location.common.a.a(context);
            ...
            bl.a(fcVar, com.amap.location.common.a.e(context));
