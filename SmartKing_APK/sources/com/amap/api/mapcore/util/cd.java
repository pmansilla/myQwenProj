...
public class cd implements Cif {
        ...
        if (sQLiteDatabase != null && i == 1) {
            ...
            if (query != null) {
                while (query.moveToNext()) {
                    String string = query.getString(query.getColumnIndex(FileDownloadModel.URL));
                    String substring = string.substring(string.lastIndexOf(FileUriModel.SCHEME) + 1);
