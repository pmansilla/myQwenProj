...
public class eo {
    ...
    public static el a(byte[] bArr) {
        ...
        try {
            ...
            try {
                ...
                elVar.a(Convert.getString(bArr, 0, 4));
                elVar.b(Convert.getString(bArr, 4, 32));
                elVar.c(Convert.getString(bArr, 36, 10));
                elVar.d(a(Convert.getSubBytes(bArr, 78, length - 78), Convert.getSubBytes(bArr, 46, 16), Convert.getSubBytes(bArr, 62, 16)));
            } catch (Throwable th) {
                th = th;
                th.printStackTrace();
                return elVar;
    ...
    private StyleElement a(Map<Integer, StyleItem> map, int i, int i2, ek ekVar) {
        StyleItem styleItem = map.get(Integer.valueOf(i));
        if (styleItem == null) {
            styleItem = new StyleItem(ekVar.c);
            styleItem.mainKey = ekVar.a;
            styleItem.subKey = ekVar.b;
    ...
    private List<ek> a(String str, String str2) {
        ArrayList arrayList = new ArrayList();
        for (ek ekVar : this.a) {
            if (ekVar != null) {
                if (ekVar.e != null && ekVar.e.equals(str2)) {
                    arrayList.add(ekVar);
                } else if (ekVar.e != null && ekVar.e.equals(str) && ekVar.f != null && ekVar.f.contains(str2)) {
                    arrayList.add(ekVar);
                }
            }
        }
    ...
    private void a(ep epVar, byte[] bArr, boolean z) {
        el a = a(bArr);
        if (a == null || a.a() == null) {
            return;
        }
                ...
                if (string == null || !string.trim().equals("sdkTextures")) {
                    if (string == null || !string.trim().equals("background")) {
                        ...
                        if (optJSONObject != null) {
                            a(string, epVar.a(), optJSONObject, z);
                        }
                    } else {
    ...
    private void a(String str, String str2, Map<Integer, StyleItem> map, JSONObject jSONObject, boolean z) throws JSONException {
        ...
        List<ek> a = a(str, str2);
        for (ek ekVar : a) {
            if (ekVar == null || ekVar.c == -1000) {
                return;
            }
            int i = ekVar.d;
            if (jSONObject.optBoolean("visible", true)) {
                if (!jSONObject.optBoolean("showIcon", true)) {
                    a(map, i, em.a("textFillColor"), ekVar).textureId = -1;
                }
                if (!jSONObject.optBoolean("showLabel", true)) {
                    a(map, i, em.a("textFillColor"), ekVar).opacity = 0.0f;
                    StyleElement a2 = a(map, i, em.a("textStrokeColor"), ekVar);
                    a2.opacity = 0.0f;
                    a2.visible = 0;
                    a2.textureId = -1;
                }
                a(map, jSONObject, "color", "opacity", i, ekVar);
                a(map, jSONObject, "fillColor", "fillOpacity", i, ekVar);
                a(map, jSONObject, "strokeColor", "strokeOpacity", i, ekVar);
                a(map, jSONObject, "textFillColor", "textFillOpacity", i, ekVar);
                a(map, jSONObject, "textStrokeColor", "textStrokeOpacity", i, ekVar);
                a(map, jSONObject, "backgroundColor", "backgroundOpacity", i, ekVar);
                if (z) {
                    a(map, jSONObject, "textureName", i, ekVar);
                }
            } else {
                StyleElement a3 = a(map, i, em.a("visible"), ekVar);
                a3.textureId = -1;
                a3.visible = 0;
            }
        }
    ...
    private void a(Map<Integer, StyleItem> map, JSONObject jSONObject, int i, int i2, ek ekVar) throws JSONException {
        int a;
        StyleElement a2 = a(map, i, i2, ekVar);
        ...
        if (i >= 30 && i <= 38) {
            a(map, i, 4, ekVar).opacity = 0.1f;
        } else if (ekVar.e != null && ekVar.e.equals("water") && i2 == 3) {
            a(map, i, 2, ekVar).value = a;
        }
    }

    private void a(Map<Integer, StyleItem> map, JSONObject jSONObject, String str, int i, ek ekVar) {
        try {
            int optInt = jSONObject.optInt(str, 0);
            if (optInt == 0) {
                return;
            }
            a(map, i, em.a(str), ekVar).textureId = optInt;
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }

    private void a(Map<Integer, StyleItem> map, JSONObject jSONObject, String str, String str2, int i, ek ekVar) {
        try {
            ...
            int a = em.a(str);
            StyleElement a2 = a(map, i, a, ekVar);
            a2.value = i2;
            a2.opacity = f;
            if (ekVar.f != null && ekVar.f.equals("China")) {
                a(map, i, a, ekVar).opacity = 0.0f;
                return;
            }
            if (ekVar.e != null && ekVar.e.equals("water") && a == 3) {
                StyleElement a3 = a(map, i, 2, ekVar);
                a3.value = i2;
                a3.opacity = f;
            }
        } catch (Throwable th) {
    ...
    private void a(Map<Integer, StyleItem> map, JSONObject jSONObject, String str, String[] strArr, int i) throws JSONException {
        for (String str2 : strArr) {
            ...
            for (ek ekVar : a(str, str2)) {
                a(map, jSONObject, ekVar.d, i, ekVar);
            }
        }
    }

    private void a(JSONArray jSONArray, String str, String str2, String str3, List<ek> list) {
        int[] iArr;
        if (jSONArray == null) {
            return;
        }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (optJSONObject != null) {
                ...
                list.add(new ek(optInt, iArr, str, str2, str3));
            }
        }
    }
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (!TextUtils.isEmpty(optString)) {
                    if ("background".equals(optString)) {
                        ...
                        String b = en.b(optString);
                        if (b != null && (a = en.a(optString)) != null && a.length != 0) {
                            String optString2 = optJSONObject.optString("elementType");
                            if (!TextUtils.isEmpty(optString2) && (a2 = em.a(optString2)) != -1) {
        ...
        if (jSONArray.length() != 0 && (optJSONObject = jSONArray.optJSONObject(0)) != null) {
            ...
            while (i5 < length) {
                ...
                if (optJSONObject3 != null) {
                    ...
                    } else if (optJSONObject3.has("subType")) {
                        JSONObject optJSONObject4 = optJSONObject3.optJSONObject("subType");
                        if (optJSONObject4 != null) {
                            ...
                            while (i6 < length2) {
                                ...
                                if (optJSONObject5 == null) {
                                    ...
                                    String optString4 = optJSONObject5.optString(IMAPStore.ID_NAME);
                                    if (optJSONObject5.has("styleMap")) {
                                        ...
                                        i = i6;
                                        i2 = length2;
                                        if (optJSONObject5.has("subType") && (optJSONObject2 = optJSONObject5.optJSONObject("subType")) != null) {
                                            ...
                                            while (i7 < length3) {
                                                ...
                                                int i8 = i7;
                                                JSONObject optJSONObject6 = optJSONObject2.optJSONObject(optString5);
                                                if (optJSONObject6 == null) {
                                                    ...
                                                    int i9 = length3;
                                                    String optString6 = optJSONObject6.optString(IMAPStore.ID_NAME);
                                                    jSONArray2 = names3;
                                                    if (optJSONObject6.has("styleMap")) {
                                                        JSONArray optJSONArray = optJSONObject6.optJSONArray("styleMap");
                                                        ...
                                                        str = optString4;
                                                        jSONObject = optJSONObject2;
                                                        a(optJSONArray, optString, sb.toString(), optString2 + "-" + optString4 + "-" + optString6, this.a);
                                                    } else {
                                                        str = optString4;
                                                        str2 = optString3;
                                                        jSONObject = optJSONObject2;
                    ...
                    this.a.add(new ek(20021, d, "roads", "trafficRoadBackgroundColor", null));
                    i5++;
    ...
    public ep a(String str, boolean z) {
    ...
    public ep a(byte[] bArr, boolean z) {
    ...
    protected void a(ep epVar) {
        if (this.c != -1) {
            Map<Integer, StyleItem> a = epVar.a();
            for (ek ekVar : a("roads", "trafficRoadBackgroundColor")) {
                a(a, ekVar.d, em.a("fillColor"), ekVar).value = this.c;
                a(a, ekVar.d, em.a("strokeColor"), ekVar).value = this.c;
            }
        }
    }

    public ep b(String str, boolean z) {
        try {
    ...
    public ep b(byte[] bArr, boolean z) {
        ep epVar = new ep();
        try {
            if (!a(epVar.a(), bArr)) {
                a(epVar, bArr, z);
