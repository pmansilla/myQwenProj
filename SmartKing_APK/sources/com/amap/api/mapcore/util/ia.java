...
public class ia {
    ...
    public static void b(final Context context) {
        try {
            ExecutorService d2 = ic.d();
            if (d2 != null && !d2.isShutdown()) {
                d2.submit(new Runnable() { // from class: com.amap.api.mapcore.util.ia.1
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        ...
        */
    static java.util.List<com.amap.api.mapcore.util.ho> c(android.content.Context r5) {
        /*
            r0 = 0
            ...
            com.amap.api.mapcore.util.il r2 = new com.amap.api.mapcore.util.il     // Catch: java.lang.Throwable -> L17
            r3 = 0
        ...
        L1f:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.ia.c(android.content.Context):java.util.List");
    }
}
