...
public final class CameraPosition implements Parcelable {
    ...
    public static final class Builder {
        ...
        public CameraPosition build() {
            try {
                ...
                ic.c(th, CameraPosition.CLASSNAME, "build");
                return null;
            }
        }
    ...
    public CameraPosition(LatLng latLng, float f, float f2, float f3) {
        ...
        if (latLng != null) {
            this.isAbroad = !fk.a(latLng.latitude, latLng.longitude);
        } else {
            this.isAbroad = false;
        }
    }
    ...
    public String toString() {
        return fr.a(fr.a("target", this.target), fr.a("zoom", Float.valueOf(this.zoom)), fr.a("tilt", Float.valueOf(this.tilt)), fr.a("bearing", Float.valueOf(this.bearing)));
    }
