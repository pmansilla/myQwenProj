...
public class AMapUtils {
    ...
    public static class a extends Thread {
        ...
        public void run() {
            if (this.b != null) {
                try {
                    hf.a(this.b, new ho.a(this.a, "6.9.3", w.c).a(new String[]{"com.amap.api.maps"}).a());
                    interrupt();
                } catch (hc e) {
                    e.printStackTrace();
                }
    ...
    private static String a(NaviPara naviPara, Context context) {
        return String.format(Locale.US, "androidamap://navi?sourceApplication=%s&lat=%f&lon=%f&dev=0&style=%d", hd.b(context), Double.valueOf(naviPara.getTargetPoint().latitude), Double.valueOf(naviPara.getTargetPoint().longitude), Integer.valueOf(naviPara.getNaviStyle()));
    }

    private static String a(PoiPara poiPara, Context context) {
        String format = String.format(Locale.US, "androidamap://arroundpoi?sourceApplication=%s&keywords=%s&dev=0", hd.b(context), poiPara.getKeywords());
