...
public class TimeScrollPicker extends RootPop {
    ...
    public TimeScrollPicker showPicker(View view, final ClickCallback clickCallback) {
        ...
        this.popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.czw.modes.pop.TimeScrollPicker.1
        ...
        this.leftItem.setOnClickListener(new View.OnClickListener() { // from class: com.czw.modes.pop.TimeScrollPicker.2
        ...
        this.rightItem.setOnClickListener(new View.OnClickListener() { // from class: com.czw.modes.pop.TimeScrollPicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
