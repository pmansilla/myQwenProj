...
public class ImagePoper extends RootPop {
    ...
    private void initPage(ArrayList<String> arrayList, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            sketchImageView.setOnClickListener(new View.OnClickListener() { // from class: com.czw.modes.pop.ImagePoper.2
    ...
    protected void initSelf() {
        ...
        this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: com.czw.modes.pop.ImagePoper.1
