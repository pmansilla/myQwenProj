...
public class PickerBirthdayPop {
    ...
    private void initWheel(View view) {
        ...
        this.yearWheelView.setOnWheelItemSelectedListener(new WheelView.OnWheelItemSelectedListener() { // from class: com.czw.smartkit.dialog.pop.PickerBirthdayPop.1
        ...
        this.monthWheelView.setOnWheelItemSelectedListener(new WheelView.OnWheelItemSelectedListener() { // from class: com.czw.smartkit.dialog.pop.PickerBirthdayPop.2
            @Override // com.wx.wheelview.widget.WheelView.OnWheelItemSelectedListener
            public void onItemSelected(int i, Object obj) {
                PickerBirthdayPop.dayDate(PickerBirthdayPop.this.getLastDay(((PickerBirthdayPop.endYear - 100) - i) + 1, PickerBirthdayPop.this.monthWheelView.getSelection() + 1));
            }
    ...
    public PickerBirthdayPop showPicker(View view, String str, final ClickCallback clickCallback) {
        ...
        this.popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.czw.smartkit.dialog.pop.PickerBirthdayPop.3
        ...
        this.leftItem.setOnClickListener(new View.OnClickListener() { // from class: com.czw.smartkit.dialog.pop.PickerBirthdayPop.4
        ...
        this.rightItem.setOnClickListener(new View.OnClickListener() { // from class: com.czw.smartkit.dialog.pop.PickerBirthdayPop.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
