...
public class ScrollPicker extends RootPop {
    ...
    protected void initSelf() {
        this.popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.czw.smartkit.dialog.pop.ScrollPicker.1
    ...
    public ScrollPicker showPicker(View view, final ClickCallback clickCallback) {
        ...
        this.leftItem.setOnClickListener(new View.OnClickListener() { // from class: com.czw.smartkit.dialog.pop.ScrollPicker.2
        ...
        this.rightItem.setOnClickListener(new View.OnClickListener() { // from class: com.czw.smartkit.dialog.pop.ScrollPicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                ScrollPicker.this.dismiss();
                if (clickCallback != null) {
