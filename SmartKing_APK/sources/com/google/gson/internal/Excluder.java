...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        Excluder m26clone = m26clone();
        if (z) {
            m26clone.serializationStrategies = new ArrayList(this.serializationStrategies);
            m26clone.serializationStrategies.add(exclusionStrategy);
        }
        if (z2) {
            m26clone.deserializationStrategies = new ArrayList(this.deserializationStrategies);
            m26clone.deserializationStrategies.add(exclusionStrategy);
        }
        return m26clone;
    }
