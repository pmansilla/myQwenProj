...
public class ResourceLoader<Data> implements ModelLoader<Integer, Data> {
    ...
    private Uri getResourceUri(Integer num) {
        try {
            return Uri.parse(AndroidResUriModel.SCHEME + this.resources.getResourcePackageName(num.intValue()) + '/' + this.resources.getResourceTypeName(num.intValue()) + '/' + this.resources.getResourceEntryName(num.intValue()));
