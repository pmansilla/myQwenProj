...
public final class ExifOrientationStream extends FilterInputStream {
    ...
    public int read() throws IOException {
        int read = (this.position < 2 || this.position > ORIENTATION_POSITION) ? super.read() : this.position == ORIENTATION_POSITION ? this.orientation : EXIF_SEGMENT[this.position - 2] & 255;
        if (read != -1) {
            this.position++;
        }
        return read;
