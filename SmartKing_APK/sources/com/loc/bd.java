...
public final class bd implements Closeable {
    ...
    private bd(InputStream inputStream, Charset charset, byte b) {
        if (inputStream == null || charset == null) {
            throw new NullPointerException();
        }
        if (!charset.equals(be.a)) {
    ...
    public final String a() throws IOException {
        ...
        synchronized (this.a) {
            ...
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream((this.e - this.d) + 80) { // from class: com.loc.bd.1
