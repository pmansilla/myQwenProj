    ...
    public void performDfu(Intent intent) throws DfuException, DeviceDisconnectedException, UploadAbortedException {
        ...
        try {
            ...
            if (bArr != null) {
                ...
                logi("Response received (Op Code = " + ((int) bArr[1]) + ", Status = " + statusCode + SQLBuilder.PARENTHESES_RIGHT);
                this.mService.sendLogBroadcast(10, "Response received (Op Code = " + ((int) bArr[1]) + ", Status = " + statusCode + SQLBuilder.PARENTHESES_RIGHT);
                if (statusCode != 1) {
