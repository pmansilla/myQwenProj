...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private static final Sink NULL_SINK = new Sink() { // from class: okhttp3.internal.DiskLruCache.4
    ...
    private final Runnable cleanupRunnable = new Runnable() { // from class: okhttp3.internal.DiskLruCache.1
    ...
    public final class Editor {
        ...
        public Sink newSink(int i) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    faultHidingSink = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) { // from class: okhttp3.internal.DiskLruCache.Editor.1
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) { // from class: okhttp3.internal.DiskLruCache.2
            static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    public synchronized Iterator<Snapshot> snapshots() throws IOException {
        initialize();
        return new Iterator<Snapshot>() { // from class: okhttp3.internal.DiskLruCache.3
